		...
		<div class="container-fluid">
			<h3 class="mt-4">${ loginID }님
				...
				<ol class="breadcrumb mb-4">
					...
					<li>이내의 영화입니다. <image onclick="refresh();"
							src="/resources/images/icons/reload.png"
	...
	<script type="text/javascript">
		...
		function distance(lat2, lon2) {
			...
			if ((lat1 == lat2) && (lon1 == lon2)) {
				...
				dist = (lat1 - lat2) * (lat1 - lat2) + (lon1 - lon2)
						* (lon1 - lon2);
				dist = Math.sqrt(dist);
		...
		function printCard(prefer, i) {
			...
			var itemStr = '<div class="card" style="max-width: 540px;"><div class="row">'
					+ '<div class="col-5" style="padding: 10px 0px 0px 15px;" onclick="toDetailPage('
					+ prefer.movie_id
					+ ')">'
					...
					+ '\', '
					+ prefer.movie_id
					+ ');">영화 보기</button></p>' + '</div></div></div></div>';
